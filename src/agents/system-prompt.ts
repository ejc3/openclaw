...
export function buildAgentSystemPrompt(params: {
  ...
  /** Defaults to true. False opts into mandatory masked credential handling. */
  ...
  const credentialSafetySection = buildCredentialSafetyPrompt(
    availableTools.has("secrets") ? resolveToolName("secrets") : undefined,
    { allowCredentialsInTranscript: params.allowCredentialsInTranscript },
  );
  const safetySection = [
    "## Safety",
