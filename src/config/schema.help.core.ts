...
export const CORE_FIELD_HELP: Record<string, string> = {
  "security.allowCredentialsInTranscript":
    "Allow ordinary agents to handle user-supplied transcript credentials (default: true). Set false to require masked entry and exclude reusable secrets from visible replies and tool arguments. This is prompt guidance, not transcript redaction; protected secrets tools and guided setup remain protected.",
  worktreeRoot:
